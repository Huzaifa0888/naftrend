    ...
    <>
      <section className="py-10  pt-20 pb-20 bgg  lg:h-[600px]">
        <div className="px-4 mx-auto max-w-[1200px] sm:px-6 lg:px-8 ">
          ...
          <h1 className="text-2xl text-center leading-snug font-extrabold text-white  mx-auto lg:w-[79%] pb-5 lg:text-[40px]">
            ...
            <ul className="flex justify-center space-x-3 ">
              <li>
                <a
                  href="#"
                  title=""
                  className="flex items-center justify-center text-white transition-all duration-200  border-white rounded-full border w-9 h-9 "
                >
                  <svg
                    className="w-4 h-4"
